        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
              <span style={{ display: 'block', height: '1px', width: '2rem', backgroundColor: GOLD }} />
              <span
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontSize: '0.75rem',
            ...
            >
              Reserva Tu <span style={{ fontStyle: 'italic', color: GOLD }}>Mesa</span>
            </h2>
            ...
            >
              Asegura tu lugar para una experiencia gastronómica inolvidable. Nuestro
              equipo se encargará de que cada detalle sea perfecto para tu ocasión
              especial.
            </p>
            ...
            <div style={{ marginTop: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.85rem', color: '#FFFFFF' }}>Horario</p>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: '#848484' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.85rem', color: '#FFFFFF' }}>Teléfono</p>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: '#848484' }}>
                    +52 (55) 1234 5678
                  </p>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.85rem', color: '#FFFFFF' }}>Dirección</p>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: '#848484' }}>
          ...
          >
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              <div>
                ...
                >
                  ...
                  {HORAS.map((h) => (
                    <option key={h} value={h} style={{ backgroundColor: '#141414' }}>
                      {h}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                >
                  ...
                  {OCASIONES.map((o) => (
                    <option key={o} value={o} style={{ backgroundColor: '#141414' }}>
                      {o}
                    </option>
                  ))}
                </select>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!submitted) e.currentTarget.style.backgroundColor = '#B8963A';
              }}
              onMouseLeave={(e) => {
